...
var CateIndex = /** @class */ (function (_super) {
    __extends(CateIndex, _super);
    function CateIndex() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    CateIndex.prototype.template = function () {
    ...
    CateIndex.prototype.afterRender = function () {
        return __awaiter(this, void 0, void 0, function () {
            function deleted(id) {
                return __awaiter(this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, CategoryAPI.delete(id).then(function () {
                                    location.reload();
                                }).catch(function (err) {
                                    console.log(err);
                                })];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        cate = _a.sent();
                        dataCate = cate.map(function (element) {
