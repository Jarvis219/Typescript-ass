...
var CateCreat = /** @class */ (function (_super) {
    __extends(CateCreat, _super);
    function CateCreat() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    CateCreat.prototype.template = function () {
    ...
    CateCreat.prototype.afterRender = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                document.getElementById('cate-data').addEventListener('submit', function (e) { return __awaiter(_this, void 0, void 0, function () {
                    var name_1, data;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                return [3 /*break*/, 3];
                            case 1:
                                name_1 = document.querySelector('#name').value;
                                data = new Category(0, name_1);
                                return [4 /*yield*/, CategoryAPI.create(data).then(function () {
