                ...
                status.addEventListener('change', function () {
                    return __awaiter(this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    if (!(status instanceof HTMLElement)) return [3 /*break*/, 2];
                                    id_1 = status.dataset.id;
                                    statusAs_1 = status.value;
                                    // console.log(statusAs)
                                    return [4 /*yield*/, OrderAPI.find(id_1)
                                            ...
                                            return __generator(this, function (_a) {
                                                switch (_a.label) {
                                                    case 0:
                                                        datas = new CheckOut(Number(id_1), data.name, data.phone, data.email, data.address, data.product, data.sumMoney, statusAs_1);
                                                        return [4 /*yield*/, OrderAPI.update(id_1, datas)
                                                                .then(function () {
