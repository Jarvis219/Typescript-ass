                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        document.querySelector('#btn-user').addEventListener('submit', function (e) { return __awaiter(_this, void 0, void 0, function () {
                            var inPName, name, email, password, passconfirm, user_1;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        e.preventDefault();
                                        ...
                                        if (!(passconfirm == password)) return [3 /*break*/, 3];
                                        user_1 = new User(Math.round(Math.random() * 700000), name, email, password, 0);
                                        if (!(typeof this._id != 'undefined')) return [3 /*break*/, 2];
                                        return [4 /*yield*/, userAPI.update(this._id, user_1).then(function () {
