        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        data = _a.sent();
                        dataUser = data.map(function (element) {
                        ...
                        document.querySelectorAll('.deleted').forEach(function (ele) {
                            ele.addEventListener('click', function (e) {
                                ...
                                if (ele instanceof HTMLElement) {
                                    ...
                                    if (typeof id == "string") {
                                        var question = confirm('you are want to delete?');
                                        if (question) {
                        ...
                        //     })
                        //     }
                        document.querySelectorAll('.permission').forEach(function (ele) {
                            ele.addEventListener('change', function (e) { return __awaiter(_this, void 0, void 0, function () {
                                var id, name_1, email, password, permission, user;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            e.preventDefault();
                                            if (!(ele instanceof HTMLElement)) return [3 /*break*/, 2];
                                            id = ele.dataset.id;
                                            if (!(typeof id == "string")) return [3 /*break*/, 2];
                                            name_1 = ele.dataset.name;
                                            email = ele.dataset.email;
                                            password = ele.dataset.pass;
                                            permission = parseInt(ele.value);
                                            if (!(typeof name_1 == 'string' && typeof email == 'string' && typeof password == 'string' && typeof permission == 'number')) return [3 /*break*/, 2];
                                            user = new User(0, name_1, email, password, permission);
                                            return [4 /*yield*/, userAPI.update(id, user)
                                                    .then(function () {
                                                    window.location.hash = '#/users/index';
